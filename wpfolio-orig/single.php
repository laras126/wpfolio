...
<div id="content">  
	...
	<div class="prevnext">
		<div class="next"><?php previous_post_link('%link', 'more', TRUE); ?></div>
		<div class="prev"><?php next_post_link('%link', 'more', TRUE); ?></div> <!-- flipped on purpose for art examples only - hopefully this makes sense, I'm not sure it does. -->
	</div> <!--.prevnext --> 
