...
<div id="content">
	...
	<?php endwhile; ?>  
		...
		<div class="prevnext">
			...
			<div class="prev"><?php next_posts_link('Newer') ?></div> <div class="next"><?php previous_posts_link('Older') ?>
			</div>
	...
	<?php if (have_posts()) : ?>  		     
		...
		<?php /* If this is a category archive */ 
			if (is_category()) { ?>				 		 
				...
				<div id="category-description" class="justify widemargins">
		...
		<div class="entrycat"> 		
			...
			<div class="img-container">
				...
				<div class="img-frame">
					...
					//If there is a post thumbnail, it will display. If not, get_thumb() assigns the first gallery image as the post thumbnail. This can be edited in the functions.php file.
					...
					<div class="img-frame-caption">
						<a title="'<?php the_title_attribute(); ?>', <?php the_time('Y') ?>" href="<?php the_permalink() ?>"><?php the_title('' ); ?></a>
